...
rm -rf npm/packages/{amis-formula,amis-core,amis-ui,amis}/node_modules
rm -rf npm/packages/{amis-formula,amis-core,amis-ui,amis}/.rollup.cache
rm -rf npm/packages/{amis-formula,amis-core,amis-ui,amis}/src
rm -rf npm/packages/{amis-formula,amis-core,amis-ui,amis}/__tests__
rm -rf npm/packages/{amis-formula,amis-core,amis-ui,amis}/.gitignore
